...
public final class StopQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Stop: GraphQLSelectionSet {
      ...
      public init(stoptimesWithoutPatterns: [StoptimesWithoutPattern?]? = nil) {
        self.init(unsafeResultMap: ["__typename": "Stop", "stoptimesWithoutPatterns": stoptimesWithoutPatterns.flatMap { (value: [StoptimesWithoutPattern?]) -> [ResultMap?] in value.map { (value: StoptimesWithoutPattern?) -> ResultMap? in value.flatMap { (value: StoptimesWithoutPattern) -> ResultMap in value.resultMap } } }])
      }
      ...
      public struct Edge: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public struct Stop: GraphQLSelectionSet {
            ...
            public init(stoptimesWithoutPatterns: [StoptimesWithoutPattern?]? = nil, gtfsId: String, name: String, platformCode: String? = nil) {
              self.init(unsafeResultMap: ["__typename": "Stop", "stoptimesWithoutPatterns": stoptimesWithoutPatterns.flatMap { (value: [StoptimesWithoutPattern?]) -> [ResultMap?] in value.map { (value: StoptimesWithoutPattern?) -> ResultMap? in value.flatMap { (value: StoptimesWithoutPattern) -> ResultMap in value.resultMap } } }, "gtfsId": gtfsId, "name": name, "platformCode": platformCode])
            }
            ...
            public struct StoptimesWithoutPattern: GraphQLSelectionSet {
              ...
              public init(headsign: String? = nil) {
                self.init(unsafeResultMap: ["__typename": "Stoptime", "headsign": headsign])
              }
