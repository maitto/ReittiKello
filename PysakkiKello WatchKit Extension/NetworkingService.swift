...
private let graphQLEndpoint = "https://api.digitransit.fi/routing/v1/routers/hsl/index/graphql"
...
class NetworkService {
    ...
    func getDeparturesForStop(_ hslStopId: String, completion: @escaping ([Departure]) -> Void) {
        apollo.clearCache()
